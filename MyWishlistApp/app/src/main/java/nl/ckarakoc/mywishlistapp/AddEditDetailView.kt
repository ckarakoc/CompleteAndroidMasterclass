...
fun AddEditDetailView(
    ...
    if (id != 0L) {
        viewModel.getWishById(id).collectAsState(initial = Wish()).value.let { wish ->
    ...
    Scaffold(
        ...
        Column(
            ...
            WishTextField(
                ...
                onValueChanged = viewModel::onWishTitleChanged
            )
            ...
            WishTextField(
                ...
                onValueChanged = viewModel::onWishDescriptionChanged
            )
...
fun WishTextFieldPrev() {
    WishTextField(label = "Title", value = "Google Watch", onValueChanged = {})
}