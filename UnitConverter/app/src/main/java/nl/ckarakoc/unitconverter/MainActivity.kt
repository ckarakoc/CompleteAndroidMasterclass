package nl.ckarakoc.unitconverter
...
import nl.ckarakoc.unitconverter.ui.theme.UnitConverterTheme
...
fun UnitConverter() {
    ...
    val customTextStyle = MaterialTheme.typography.headlineLarge.copy(
